...
ip netns exec net0 ip addr add 192.168.2.1/24 dev veth-0r
ip netns exec net1 ip addr add 192.168.2.2/24 dev veth-1l
...
ip netns exec net4 ip addr add 192.168.5.2/24 dev veth-4l

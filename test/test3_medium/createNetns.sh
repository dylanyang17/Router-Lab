...
ip netns add net3
ip netns add net4
ip link add veth-0l type veth peer name veth-00 # 00 is not used
...
ip link set veth-00 netns nettmp
ip link set veth-0l netns net0
...
ip netns exec net0 ip link set veth-0l up
...
ip netns exec net0 ethtool -K veth-0l tx off
